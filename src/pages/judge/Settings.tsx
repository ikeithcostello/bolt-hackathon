            ...
            <CardContent className="p-0">
              <ul className="divide-y divide-gray-800">
                <li className="p-4 bg-accent-blue bg-opacity-20 border-l-4 border-accent-blue">
                  <a href="#personal" className="flex items-center text-accent-blue">
                ...
                <li className="p-4 hover:bg-gray-800 transition-colors">
                  <a href="#evaluation" className="flex items-center text-gray-300 hover:text-white">
          ...
          <Card id="notifications">
            ...
            <CardContent>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-3 bg-gray-800 rounded-md">
                  <div>
                    <h4 className="text-sm font-medium">Calibration Sessions</h4>
                    <p className="text-xs text-gray-400">Get notified about upcoming calibration sessions</p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input 
                      type="checkbox" 
